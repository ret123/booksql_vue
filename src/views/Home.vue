  ...
  <div class="home">
    <div class="hero bg-gray-400 mb-24">
      <div class="container mx-auto flex flex-col lg:flex-row lg:justify-between py-10">
        <div class="mt-10">
          <h1 class="w-full lg:w-3/4 mb-4 text-4xl">Book recommendation site built with GraphQL</h1>
          <p
          ...
          <div class="flex items-center">
            <a
              href="#"
              class="bg-purple-800 text-white rounded px-4 py-4 mr-4 hover:bg-purple"
            >View Books</a>
            <a
              href="#"
              class="border border-purple-800 border-solid rounded text-purple-dark px-4 py-4 hover:bg-purple hover:text-white"
            >View Screencasts</a>
          </div>
        </div>
...
import categoriesQuery from "../graphql/query/Categories.gql";
import categoryQuery from "../graphql/query/Category.gql";
import booksByFeaturedQuery from "../graphql/query/BooksByFeatured.gql";
